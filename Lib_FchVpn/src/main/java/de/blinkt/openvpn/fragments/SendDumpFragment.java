...
public class SendDumpFragment extends Fragment {
    ...
    private static final String TAG = "SendDumpFragment";
    ...
    public void emailMiniDumps() {
        ...
        //HEDA 12/28 要在这里使用FileProvider

        uris.add(Uri.parse("content://de.blinkt.openvpn.MineFileProvider/" + ldump.first.getName()));
        uris.add(Uri.parse("content://de.blinkt.openvpn.MineFileProvider/" + ldump.first.getName() + ".log"));

        Log.e(TAG, "emailMiniDumps: " + ldump.first.getName());
        Log.e(TAG, "emailMiniDumps: " + ldump.first.getName() + ".log");
        Log.e(TAG, "emailMiniDumps: " + "9999999999999999999999999999999999999999999999999");
